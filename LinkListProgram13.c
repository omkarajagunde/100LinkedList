...
// This function will concat the 2nd Link list's n nodes to the 1st Link List ..
int concatFirstN(SLLNode **sourceList, SLLNode **destList,int n){
	...
	do{
		...
		switch(choice){
			...
			case 4: if(attempt == 1){
					...
					scanf("%d",&data);
					concatFirstN(&headNodeListTwo,&headNodeListOne,data); 
				attempt += 1;
				}else
