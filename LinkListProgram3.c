...
// This function will add a new node to the starting of the nodes ...
int insertAtPosition(SLLNode **headNode, int num, int position){
	...
	do{
		...
		switch(choice){
			...
			case 3: printf("\nEnter a data to add in Node :");
				...
				scanf("%d",&position);
				insertAtPosition(&headNode, data, position); 
				break;
