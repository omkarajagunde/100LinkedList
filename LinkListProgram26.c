...
// in descending order of their respective data ...
int copyDsc(SLLNode **srcList, SLLNode **destList){
...
void main(void){
	...
	do{
		...
		printf("3] Copy list 1 @ list 2 in descending Order ? :\n");
		printf("4] Exit :\n");
		...
		switch(choice){
			...
			case 3: headNodeListTwo = NULL;
                copyDsc(&headNodeListOne, &headNodeListTwo);
				break;
