...
// This function will copy the first N nodes from source list to
// destination list ...
int llNCopy(SLLNode **srcList, SLLNode **destList, int n){
...
void main(void){
	...
	do{
		...
		printf("3] Copy no. of nodes of List 1 @ List 2 ? :\n");
		printf("4] Exit :\n");
		...
		switch(choice){
			...
			case 3: printf("Enter no. of nodes to copy ? :");
                scanf("%d", &data);
                llNCopy(&headNodeListOne,&headNodeListTwo,data); 
				break;
