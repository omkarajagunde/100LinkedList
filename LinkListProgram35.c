...
int listSortAsc(SLLNode **srcList){
...
void main(void){
	...
	do{
		...
		printf("3] Show Link list 1 is Ascending order ? :\n");
		printf("4] Exit :\n");
		...
		switch(choice){
			...
			case 2:	displayNodes(&headNodeListOne);
				break;
			case 3: 
                retValue = listSortAsc(&headNodeListOne);   
                printf(CYN"\t\tList 1 sorted in Ascending order (choose option 2 to display sorted list) ..."RESET);
                break;
